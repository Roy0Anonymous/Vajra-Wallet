...
public class FileHandler {
    ...
    static func removeAll() throws {
        let urls = try FileHandler.contentsOfDirectory()
...
//        let url = getDocumentsDirectory().appendingPathComponent(path).absoluteString
//        let res = fileManager.fileExists(atPath: url)
//        return res
//    }
//
